...
<Library LVVersion="20008000">
	...
	<Item Name="API" Type="Folder">
		...
		<Item Name="NNPC_Generate_Embedding" Type="Folder">
			...
			<Item Name="NNPC_Generate_Embedding(Image(Batch)).vi" Type="VI" URL="../API/NNPC_Generate_Embedding/NNPC_Generate_Embedding(Image(Batch)).vi"/>
		</Item>
		<Item Name="NNPC_Predict" Type="Folder">
			<Item Name="NNPC_Predict(Batch).vi" Type="VI" URL="../API/NNPC_Predict/NNPC_Predict(Batch).vi"/>
			<Item Name="NNPC_Predict(Dataset).vi" Type="VI" URL="../API/NNPC_Predict/NNPC_Predict(Dataset).vi"/>
			<Item Name="NNPC_Predict(Single).vi" Type="VI" URL="../API/NNPC_Predict/NNPC_Predict(Single).vi"/>
		</Item>
	...
	<Item Name="Low_Level" Type="Folder">
		<Item Name="Common" Type="Folder">
			...
			<Item Name="Permute_Array.vi" Type="VI" URL="../Low_Level/Common/Permute_Array.vi"/>
		</Item>
		<Item Name="Controls" Type="Folder">
		...
		<Item Name="Progress Bar" Type="Folder">
			<Item Name="API" Type="Folder">
				<Item Name="ProgBar_Send.vi" Type="VI" URL="../Low_Level/Progress Bar/API/ProgBar_Send.vi"/>
			</Item>
			<Item Name="controls" Type="Folder">
				<Item Name="System_Custom" Type="Folder">
					<Item Name="Cancel.ctl" Type="VI" URL="../Low_Level/Progress Bar/controls/System_Custom/Cancel.ctl"/>
				</Item>
				<Item Name="ProgBar_Element.ctl" Type="VI" URL="../Low_Level/Progress Bar/controls/ProgBar_Element.ctl"/>
				<Item Name="ProgBar_Msg.ctl" Type="VI" URL="../Low_Level/Progress Bar/controls/ProgBar_Msg.ctl"/>
			</Item>

...
<Project Type="Project" LVVersion="20008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="1_Waveform_Signal_Regression(Training).vi" Type="VI" URL="../1_Waveform_Signal_Regression(Training).vi"/>
		<Item Name="2_Waveform_Signal_Regression(Inference).vi" Type="VI" URL="../2_Waveform_Signal_Regression(Inference).vi"/>
